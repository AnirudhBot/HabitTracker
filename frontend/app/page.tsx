    ...
    <div className="flex flex-col items-center justify-center min-h-screen text-gray-900">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center text-center p-4">
        ...
        <p className="text-lg mb-8 max-w-2xl">
          HabitTracker is your personal assistant in building and maintaining good habits. 
          Track your daily goals, connect with friends, and earn rewards for your achievements.
        </p>
